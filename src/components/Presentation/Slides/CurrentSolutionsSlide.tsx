...
const CurrentSolutionsSlide = () => {
  const solutions = [{
    ...
    bullets: ["Slow & inconsistent performance", "Hard to scale across shifts", "Dependent on expert availability"],
    verdict: "High Cost",
    ...
    bullets: ["Only works for stable processes", "Struggles with variability & light", "Long tuning cycles per change"],
    verdict: "Inflexible",
    ...
    bullets: ["Expensive, scarce AI talent", "Constant model maintenance", "Distracts from core business"],
    ...
    padding: '2.5cm'
      ...
      <div className="relative z-10 w-full h-full flex flex-col justify-center">
        ...
        marginBottom: '2vh'
          ...
          <p className="text-muted-foreground mx-auto text-center whitespace-nowrap" style={{
        ...
        gap: 'clamp(0.75rem, 1.5vw, 2rem)'
          ...
          return <motion.div key={solution.title} initial={{
            opacity: 0,
            y: 30
          }} animate={{
            opacity: 1,
            ...
            ease: [0.22, 1, 0.36, 1]
                ...
                padding: 'clamp(1.25rem, 2.5vw, 2.5rem)'
                  ...
                  marginBottom: 'clamp(0.75rem, 2vh, 2rem)'
                      ...
                      <div className={`rounded-2xl ${solution.iconBg} ring-1 ring-inset ring-white/10 group-hover:scale-110 transition-transform duration-500`} style={{
                    ...
                    marginBottom: 'clamp(0.75rem, 1.5vh, 1.5rem)'
                      ...
                      <h3 className="font-bold text-foreground" style={{
                    fontSize: 'clamp(1.25rem, 2.5vw, 2.5rem)',
                    marginBottom: '0.5vh'
                  }}>
                        {solution.title}
                      </h3>
                      <p className="text-muted-foreground uppercase tracking-wider font-medium" style={{
                    ...
                    <Separator className="bg-border/50" style={{
                  marginBottom: 'clamp(0.75rem, 2vh, 2rem)'
                }} />
                  ...
                  marginBottom: 'clamp(0.75rem, 1.5vh, 1.5rem)'
                      ...
                      {solution.bullets.map((bullet, i) => <li key={i} className="flex items-start group/item" style={{
                    gap: 'clamp(0.4rem, 0.75vw, 0.75rem)',
                    marginBottom: 'clamp(0.5rem, 0.75vh, 0.75rem)'
                  }}>
                          <XCircle className={`${solution.iconColor} opacity-60 group-hover/item:opacity-100 transition-opacity mt-0.5 shrink-0`} style={{
                      width: 'clamp(1.1rem, 1.75vw, 1.75rem)',
                      height: 'clamp(1.1rem, 1.75vw, 1.75rem)'
                    }} />
                          <span className="text-muted-foreground leading-relaxed group-hover/item:text-foreground transition-colors" style={{
                    ...
                    {/* Verdict Footer */}
                    <div className="mt-auto border-t border-border/50 text-center" style={{
                  paddingTop: 'clamp(0.75rem, 1.5vh, 1.5rem)'
                }}>
                      <p className="text-muted-foreground uppercase tracking-widest" style={{
                    fontSize: 'clamp(0.65rem, 1vw, 1rem)',
                    marginBottom: '0.5vh'
                  }}>
                        Verdict
                      </p>
                      <p className={`font-bold ${solution.verdictColor}`} style={{
                    fontSize: 'clamp(1.25rem, 2.5vw, 2.5rem)'
                  }}>
                        {solution.verdict}
                      </p>
