...
const TitleSlide = () => {
  return <div className="w-full min-h-screen flex flex-col justify-center relative bg-background">
      ...
      <motion.div className="absolute top-6 left-6 z-20" initial={{
      opacity: 0,
      x: -20
    }} animate={{
      opacity: 1,
      ...
      <div className="relative z-10 text-center px-8 py-16">
        ...
        {/* Institutional Logos */}
        <motion.div className="items-center justify-center gap-8 max-w-3xl mx-auto mt-8 flex flex-row" initial={{
        opacity: 0,
        y: 30
      }} animate={{
        opacity: 1,
