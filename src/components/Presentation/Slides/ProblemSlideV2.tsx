...
const ProblemSlideV2 = () => {
  return <div className="w-full h-screen flex items-center justify-center bg-background relative overflow-hidden" style={{
    padding: '2.5cm'
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full h-full" style={{
      gap: '3vh'
    }}>
        {/* Header */}
        <motion.div initial={{
        ...
        ease: [0.22, 1, 0.36, 1]
          ...
          <h1 className="font-bold text-foreground tracking-tight text-center text-9xl" style={{
          ...
          <h2 className="font-bold text-destructive tracking-tight text-center text-9xl" style={{
          fontSize: 'clamp(3rem, 7vw, 6rem)',
          marginBottom: '1vh',
          lineHeight: 1.1
        }}>
          ...
          <p className="text-muted-foreground text-center whitespace-nowrap" style={{
        ...
        {/* Pain Points Grid */}
        <div className="grid grid-cols-2 w-full" style={{
        gap: 'clamp(1rem, 2vw, 2.5rem)'
          ...
          delay: 0.2
            ...
            <Card className="relative h-full overflow-hidden border-0 bg-gradient-to-b from-destructive/10 to-background ring-1 ring-destructive/20 hover:ring-destructive/50 transition-all duration-500 group">
              <div className="absolute top-0 right-0 opacity-10 group-hover:opacity-20 transition-opacity" style={{
              ...
              padding: 'clamp(2rem, 4vw, 4rem)'
                ...
                <div className="rounded-2xl bg-destructive/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300" style={{
                ...
                <p className="text-muted-foreground leading-relaxed flex-grow" style={{
                ...
                <div className="border-t border-destructive/20" style={{
                paddingTop: '2vh'
              }}>
                  <div className="flex items-baseline" style={{
                  gap: 'clamp(0.75rem, 1.25vw, 1.25rem)'
                }}>
                    <span className="font-bold text-destructive" style={{
          ...
          delay: 0.4
            ...
            <Card className="relative h-full overflow-hidden border-0 bg-gradient-to-b from-warning/10 to-background ring-1 ring-warning/20 hover:ring-warning/50 transition-all duration-500 group">
              ...
              padding: 'clamp(2rem, 4vw, 4rem)'
                ...
                <div className="rounded-2xl bg-warning/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300" style={{
                width: 'clamp(3.5rem, 5.5vw, 5.5rem)',
                height: 'clamp(3.5rem, 5.5vw, 5.5rem)',
                marginBottom: '2vh'
              }}>
                ...
                <div className="border-t border-warning/20" style={{
                paddingTop: '2vh'
              }}>
                  <div className="flex items-baseline" style={{
                  gap: 'clamp(0.75rem, 1.25vw, 1.25rem)'
                }}>
                    <span className="font-bold text-warning" style={{
                    fontSize: 'clamp(2rem, 4vw, 4rem)'
                  }}>
                      2-5 Days
                    </span>
